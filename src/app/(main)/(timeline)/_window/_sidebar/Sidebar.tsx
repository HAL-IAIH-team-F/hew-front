...
const Sidebar: React.FC<SidebarProps> = ({}) => {
    ...
    useEffect(() => {
        ...
        if (pathname === "/account") return setActiveIndex(1)
                ...
                <div style={{height: "100%", boxSizing:"border-box", position:"relative" }}>
                    ...
                    {activeIndex !== null && (
                        ...
                        <div style={{ ...selectedRouteStyle, boxSizing:"border-box",  top: `calc(${activeIndex * 12.5 }%)` }}>
                            <div style={ {height: "100%", marginTop: "-12px",padding: "12px 0" , backgroundColor: "rgb(255, 255, 255,0.4)",  borderRadius: '60px', border: '1px solid rgb(255, 255, 255,0.4)'}}>
                                
                            </div>
                        </div>
                    )}
                
                    <SidebarRoutesLink routeUrl={routes.timeline()} setTransitions={setTransitions}><House style={iconstyles.icon}/></SidebarRoutesLink>
                    <SidebarRoutesLink routeUrl={routes.account()} setTransitions={setTransitions}>{user && user.icon ? (
                        <Image
                            alt="User Icon"
                    ...
                    <SidebarRoutesLink routeUrl={routes.search()} setTransitions={setTransitions}><FaSearch style={iconstyles.icon}/></SidebarRoutesLink>
