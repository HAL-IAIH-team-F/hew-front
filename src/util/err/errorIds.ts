...
export class ErrorIds {
  ...
  static readonly AuthImplicitFlowResError = createErrorId("AuthImplicitFlowResError");
  static readonly AuthImplicitFlowIdError = createErrorId("AuthImplicitFlowIdError");
  static readonly AuthImplicitFlowAccessError = createErrorId("AuthImplicitFlowAccessError");
  static readonly ApiError = createErrorId("ApiError");
  static readonly CallbackError = createErrorId("CallbackError");
  ...
  static readonly NoToken = createErrorId("NoToken");
