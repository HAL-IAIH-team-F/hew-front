...
const PurchaseYesNo: React.FC<PurchaseYesNoProps> = ({
                                                         isModalOpen,
                                                         onClose,
                                                         setCompleteOpen,
                                                         setPurchased_Products
                                                     }) => {
    ...
    const handlePurchase = async () => {
        try {
            if (clientState.state !== "registered") return setErr("not authenticated");
...
const PurchaseComplete: React.FC<{
    ...
    onClose: () => void;
    Purchased_Products?: CartRes
}> = ({isCompleteOpen, onClose, Purchased_Products}) => {
...
export const usePurchaseYesNo = (): [JSX.Element | null, () => void, JSX.Element | null,] => {
    ...
    return [
        <PurchaseYesNo isModalOpen={isModalOpen} onClose={() => setIsModalOpen(false)}
                       setCompleteOpen={setIsCompleteOpen} setPurchased_Products={setPurchased_Products}/>,
        showPurchaseYesNo,
        <PurchaseComplete isCompleteOpen={isCompleteOpen} onClose={() => setIsCompleteOpen(false)}
...
const ProductList: React.FC<ProductListProps> = ({productId}) => {
    ...
    return (
        <>
            {products.map(({product_id, product_thumbnail_uuid, product_title}) => (
