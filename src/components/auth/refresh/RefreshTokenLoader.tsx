...
async function handleRefresh(
    ...
    setClientState(
        newRegisteredClientState(idToken.oidcContext, setIdToken, () => {
            setLogoutRequestIdToken(idToken)
        }, tokens, idToken, result.success, setClientState)
    )
}
...
export default function RefreshTokenLoader(
    ...
    useEffect(() => {
        ...
        if (idToken.state == "unauthenticated") {
            return setClientState(newUnAuthClientState(idToken.oidcContext, setIdToken, idToken, setClientState))
        }
        ...
        const timeout = setTimeout(() => {
            ...
            ApiRefresh.refreshToken(
                ...
                setClientState(newUnAuthClientState(idToken.oidcContext, setIdToken, idToken, setClientState))
            })
        }, next)
        return () => {
