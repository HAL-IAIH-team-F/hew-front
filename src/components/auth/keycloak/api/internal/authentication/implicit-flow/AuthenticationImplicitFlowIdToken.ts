...
export class AuthenticationImplicitFlowIdToken {
  private constructor(
   ...
   * @param context
   */
  static async instance(idToken: string, context: OidcContext): Promise<AuthenticationImplicitFlowIdToken> {
    ...
    return new AuthenticationImplicitFlowIdToken(claims, jwt)
  }
}