...
// @ts-ignore
  ...
  export const ERR_INVALID_ARG_VALUE = 'ERR_INVALID_ARG_VALUE'
  export const ERR_INVALID_ARG_TYPE = 'ERR_INVALID_ARG_TYPE'

  type codes = typeof ERR_INVALID_ARG_VALUE | typeof ERR_INVALID_ARG_TYPE

  export function CodedTypeError(message: string, code: codes, cause?: unknown) {
  ...
  export function OPE(message: string, code?: string, cause?: unknown) {
    return new OperationProcessingError(message, {code, cause})
  }

  export function assertCryptoKey(key: unknown, it: string): asserts key is CryptoKey {
  ...
  export function assertPublicKey(key: unknown, it: string): asserts key is CryptoKey & { type: 'public' } {
    assertCryptoKey(key, it)
  ...
  export function normalizeTyp(value: string) {
  ...
  export function prepareHeaders(input?: [string, string][] | Record<string, string> | Headers): Headers {
  ...
  export function signal(value: Exclude<HttpRequestOptions<any>['signal'], undefined>): AbortSignal {
  ...
  export function assertApplicationJson(response: Response): void {
    assertContentType(response, 'application/json')
  }

  export function notJson(response: Response, ...types: string[]) {
  ...
  export function assertContentTypes(response: Response, ...types: string[]): void {
  ...
  export interface NormalizedKeyInput {
    key?: CryptoKey
    kid?: string
  }

  export function getKeyAndKid(input: CryptoKey | PrivateKey | undefined): NormalizedKeyInput {
   ...
   */
  export function psAlg(key: CryptoKey): string {
   ...
   */
  export function rsAlg(key: CryptoKey): string {
    switch ((key.algorithm as RsaHashedKeyAlgorithm).hash.name) {
      case 'SHA-256':
        return 'RS256'
      case 'SHA-384':
   ...
   */
  export function esAlg(key: CryptoKey): string {
   ...
   */
  export function keyToJws(key: CryptoKey) {
  ...
  export function getClockSkew(client?: Pick<Client, typeof clockSkew>) {
    const skew = client?.[clockSkew]

    return typeof skew === 'number' && Number.isFinite(skew) ? skew : 0
  }

  export function getClockTolerance(client?: Pick<Client, typeof clockTolerance>) {
  ...
  export function assertAs(as: AuthorizationServer): asserts as is AuthorizationServer {
  ...
  export function assertClient(client: Client): asserts client is Client {
   ...
   */
  export function formUrlEncode(token: string) {
  ...
  export function clientAssertionPayload(as: AuthorizationServer, client: Client) {
  ...
  export async function getSetPublicJwkCache(key: CryptoKey) {
   ...
   */
  export async function publicJwk(key: CryptoKey) {
    jwkCache ||= new WeakMap()
    return jwkCache.get(key) || getSetPublicJwkCache(key)
  }

// @ts-ignore
  export const URLParse: (url: string | URL, base?: string | URL) => URL | null = URL.parse
    ? // @ts-ignore
  ...
  export function checkProtocol(url: URL, enforceHttps: boolean | undefined) {
    if (!Env.debug && enforceHttps && url.protocol !== 'https:') {
  ...
  export const SPLIT_REGEXP = /((?:,|, )?[0-9a-zA-Z!#$%&'*+-.^_`|~]+=)/
  export const SCHEMES_REGEXP = /(?:^|, ?)([0-9a-zA-Z!#$%&'*+\-.^_`|~]+)(?=$|[ ,])/g

  export function wwwAuth(scheme: string, params: string): WWWAuthenticateChallenge {
  ...
  export function assertDPoP(option: DPoPHandle): asserts option is DPoPHandler {
  ...
  export function isFreshJwksCache(input: unknown): input is ExportedJWKSCache {
  ...
  export function clearJwksCache(as: AuthorizationServer, cache?: Partial<JWKSCacheInput>) {
    jwksMap?.delete(as)
    delete cache?.jwks
    delete cache?.uat
  }

  export async function getPublicSigKeyFromIssuerJwksUri(
    as: AuthorizationServer,
  ...
  export function getContentType(input: Response | Request) {
  ...
  export async function tokenEndpointRequest(
    as: AuthorizationServer,
    client: Client,
    clientAuthentication: ClientAuth,
    grantType: string,
  ...
  export const idTokenClaims = new WeakMap<TokenEndpointResponse, IDToken>()
  export const jwtRefs = new WeakMap<Response, string>()
  ...
  export async function processGenericAccessTokenResponse(
    as: AuthorizationServer,
    client: Client,
    response: Response,
  ...
  export function validateOptionalAudience(
    expected: string,
  ...
  export function validateAudience(expected: string, result: Awaited<ReturnType<typeof validateJwt>>) {
  ...
  export function validateOptionalIssuer(
    as: AuthorizationServer,
    result: Awaited<ReturnType<typeof validateJwt>>,
  ) {
  ...
  export function validateIssuer(as: AuthorizationServer, result: Awaited<ReturnType<typeof validateJwt>>) {
    // @ts-ignore
  ...
  export const branded = new WeakSet<URLSearchParams | DPoPHandle>()

  export function brand(searchParams: URLSearchParams) {
  ...
  export interface CompactJWSHeaderParameters {
    alg: string
    kid?: string
    typ?: string
    crit?: string[]
  ...
  export function checkJwtType(expected: string, result: Awaited<ReturnType<typeof validateJwt>>) {
  ...
  export function assertReadableResponse(response: Response): void {
  ...
  export async function processJwksResponse(response: Response): Promise<JWKS> {
    if (!looseInstanceOf(response, Response)) {
      throw CodedTypeError('"response" must be an instance of Response', ERR_INVALID_ARG_TYPE)
    }
  ...
  export async function handleOAuthBodyError(response: Response): Promise<OAuth2Error | undefined> {
  ...
  export function supported(alg: string) {
    switch (alg) {
      case 'PS256':
      case 'ES256':
      case 'RS256':
  ...
  export function checkSupportedJwsAlg(header: CompactJWSHeaderParameters) {
  ...
  export function checkRsaKeyAlgorithm(key: CryptoKey) {
  ...
  export function ecdsaHashName(key: CryptoKey) {
  ...
  export function keyToSubtle(key: CryptoKey): AlgorithmIdentifier | RsaPssParams | EcdsaParams {
    switch (key.algorithm.name) {
      case 'ECDSA':
        return {
  ...
  export async function validateJwsSignature(
  ...
  export async function idTokenHash(data: string, header: CompactJWSHeaderParameters, claimName: string) {
  ...
  export async function idTokenHashMatches(
    data: string,
    actual: string,
    header: CompactJWSHeaderParameters,
    claimName: string,
  ...
  export async function consumeStream(request: Request) {
    if (request.bodyUsed) {
      throw CodedTypeError(
  ...
  export async function formPostResponse(request: Request) {
  ...
  export async function validateHybridResponse(
    as: AuthorizationServer,
    client: Client,
    parameters: URLSearchParams | URL | Request,
    expectedNonce: string,
   ...
   * failure
   */
  export function checkSigningAlgorithm(
   ...
   */
  export function getURLSearchParameter(parameters: URLSearchParams, name: string): string | undefined {
  ...
  export function algToSubtle(alg: string): RsaHashedImportParams | EcKeyImportParams | AlgorithmIdentifier {
    switch (alg) {
      case 'PS256': // Fall through
      case 'PS384': // Fall through
      case 'PS512':
  ...
  export async function importJwk(alg: string, jwk: JWK) {
  ...
  export function normalizeHtu(htu: string) {
  ...
  export function reassignRSCode(err: unknown): never {
