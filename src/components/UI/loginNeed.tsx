...
export default function LoginNeed() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6">
      {/* 背景のアクセント */}
      <div className="absolute inset-0 bg-opacity-30 pointer-events-none" />
      
      <div className="relative bg-gray-800/90 backdrop-blur-lg rounded-3xl shadow-2xl p-10 text-center w-full max-w-md border border-gray-700 overflow-hidden">
        {/* モーダルの装飾（控えめ） */}
